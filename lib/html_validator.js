...
const validateHtmlSource = fileContent => {
  return start()
  .then(() => vnu.validate(fileContent))
  .then(validationMessages => processValidatorResult(fileContent, validationMessages));
};

const processValidatorResult = (fileContent, validationMessages) => {
